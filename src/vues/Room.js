...
import { getRoomInfo, askToStartGame } from '../api/clientApi'
        ...
        <div className="homeMenu" id="inRoom">
          ...
          <div className="bottomPanel" id="inRoom">
            ...
            <div className="blocMenu" id="listPlayers">
              ...
              <button className="roomButton" id="launchGame" onClick={() => { askToStartGame(this.props.socketConnector.socket, this.state.profil, this.state.roomUrl, undefined) }}>
